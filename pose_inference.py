...
smoothing_factor = 0.7  # Adjust this factor (0.0 for no smoothing; closer to 1.0 is smoother but laggier)
...
with mp_pose.Pose(min_detection_confidence=0.6, min_tracking_confidence=0.6) as pose:
    while cap.isOpened():
        ...
        # Default values.
        skeleton_color = (0, 0, 255)  # Red for incorrect or not detected.
        ...
        if results.pose_landmarks:
            ...
            # Combined if-elif-else chain using both ML prediction and angle logic.
            if pred_class == "Warrior Pose" and warrior_pose:
                ...
                skeleton_color = (0, 255, 0)
                accuracy_text = f"Accuracy: {max_prob * 100:.1f}%"
            elif pred_class == "Triangle Pose" and triangle_pose:
